  ...
  return (
    <div className="relative">
      ...
      <Dropdown
        ...
        className="mt-[17px] flex max-h-[min(480px,calc(100vh-6rem))] w-[calc(100vw-1.5rem)] max-w-[361px] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark left-1/2 -translate-x-1/2 md:left-auto md:right-0 md:translate-x-0"
      >
